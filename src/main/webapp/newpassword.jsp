...
<%
String URL = request.getRequestURL().toString().replace("/newpassword.jsp", "");
...
<html lang="pt-BR">
    <head>
        ...
        <title><%=I18nUtil.i18n("PASSWORD_CHANGE", Language)%></title>
    </head>
    <body class="newpassword-body">
        ...
        <div class="newpassword-content">
            <div class="py-5">
                <div class="container">
                    <form method="POST" action="User?a=password">
