<%-- 
    Document   : newuser
    Created on : Apr 21, 2022, 7:01:42 PM
...
<%
String URL = request.getRequestURL().toString().replace("/newuser.jsp", "");
...
<html lang="pt-BR">
    <head>
        ...
        <title><%=I18nUtil.i18n("NEW_USER", Language)%></title>
    </head>
                ...
                <div class="container">
                    <form method="POST" action="User?a=submit">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="password" id="password" placeholder="<%=I18nUtil.i18n("PASSWORD", Language)%>" autocomplete="off" aria-describedby="passwordHelp" required>
                            <small id="passwordHelp" class="text-muted"><%=I18nUtil.i18n("PASSWORD_HELP", Language)%></small>
                        </div>
                        <div class="form-group">
                            <label for="role"><b> <%=I18nUtil.i18n("ROLE", Language)%> </b></label>
                            <select class="form-control" name="role" id="role">
                                <option value="Administrator"> <%=I18nUtil.i18n("ADMINISTRATOR", Language)%> </option>
                                <option value="Operator"> <%=I18nUtil.i18n("OPERATOR", Language)%> </option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="language"><b> <%=I18nUtil.i18n("LANGUAGE", Language)%> </b></label>
                            <select class="form-control" name="language" id="language">
                                <option value="<%=I18nCSV.EN_US%>"> <%=I18nUtil.i18n("ENGLISH", Language)%> </option>
                                <option value="<%=I18nCSV.PT_BR%>"> <%=I18nUtil.i18n("PORTUGUESE", Language)%> </option>
                            </select>
                        </div>
